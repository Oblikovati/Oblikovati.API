...
// its index, kind ([github.com/Oblikovati/api/types.GeometricConstraintKind]), and the
...
// its index, kind ([github.com/Oblikovati/api/types.DimensionConstraintKind]), backing
