...
// another — reusing a profile across features and planes. The source entities'
// sketch-local coordinates are re-instantiated in the
...
// clones — while relations that reference geometry outside the set are dropped
// (Oblikovati/Oblikovati#1083). A copied driving dimension mints a fresh
