// Module github.com/Oblikovati/api is the public, Apache-2.0 automation contract
...
// github.com/Oblikovati/oblikovati — the dependency only ever flows the other way.
// See architecture/decisions/ADR-0018.
module github.com/Oblikovati/api
