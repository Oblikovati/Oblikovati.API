...
func (a AssemblyJoints) List() (wire.AssemblyJointsResult, error) {
	return call[wire.AssemblyJointsResult](a.c, wire.MethodAssemblyJointsList, struct{}{})
}
...
func (a AssemblyJoints) AddRigid(args wire.AddJointArgs) (wire.AssemblyJointResult, error) {
	return call[wire.AssemblyJointResult](a.c, wire.MethodAssemblyJointsAddRigid, args)
}
...
func (a AssemblyJoints) AddRotational(args wire.AddJointArgs) (wire.AssemblyJointResult, error) {
	return call[wire.AssemblyJointResult](a.c, wire.MethodAssemblyJointsAddRotational, args)
}
...
func (a AssemblyJoints) AddSlider(args wire.AddJointArgs) (wire.AssemblyJointResult, error) {
	return call[wire.AssemblyJointResult](a.c, wire.MethodAssemblyJointsAddSlider, args)
}
...
func (a AssemblyJoints) AddCylindrical(args wire.AddJointArgs) (wire.AssemblyJointResult, error) {
	return call[wire.AssemblyJointResult](a.c, wire.MethodAssemblyJointsAddCylindrical, args)
}
...
func (a AssemblyJoints) AddPlanar(args wire.AddJointArgs) (wire.AssemblyJointResult, error) {
	return call[wire.AssemblyJointResult](a.c, wire.MethodAssemblyJointsAddPlanar, args)
}
...
func (a AssemblyJoints) AddBall(args wire.AddJointArgs) (wire.AssemblyJointResult, error) {
	return call[wire.AssemblyJointResult](a.c, wire.MethodAssemblyJointsAddBall, args)
}
...
func (a AssemblyJoints) Delete(id uint64) (wire.AssemblyJointsResult, error) {
	return call[wire.AssemblyJointsResult](a.c, wire.MethodAssemblyJointsDelete, wire.DeleteJointArgs{ID: id})
}
...
func (a AssemblyJoints) SetLimits(args wire.SetJointLimitsArgs) (wire.AssemblyJointResult, error) {
	return call[wire.AssemblyJointResult](a.c, wire.MethodAssemblyJointsSetLimits, args)
}
...
func (d DSJoints) List() (wire.DSJointsResult, error) {
	return call[wire.DSJointsResult](d.c, wire.MethodDSJointsList, struct{}{})
}
...
func (d DSJoints) Add(args wire.AddDSJointArgs) (wire.DSJointResult, error) {
	return call[wire.DSJointResult](d.c, wire.MethodDSJointsAdd, args)
}
...
func (d DSJoints) SetImposedMotion(args wire.SetImposedMotionArgs) (wire.DSJointResult, error) {
	return call[wire.DSJointResult](d.c, wire.MethodDSJointsSetImposedMotion, args)
}
...
func (d DSJoints) Delete(id uint64) (wire.DSJointsResult, error) {
	return call[wire.DSJointsResult](d.c, wire.MethodDSJointsDelete, wire.DeleteDSJointArgs{ID: id})
}
