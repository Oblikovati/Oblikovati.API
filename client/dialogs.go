...
func (d Dialogs) ShowFileDialog(args wire.ShowFileDialogArgs) (wire.OKResult, error) {
	return call[wire.OKResult](d.c, wire.MethodDialogsShowFileDialog, args)
}
...
func (d Dialogs) ShowWebDialog(spec wire.WebDialogSpec) (wire.OKResult, error) {
	return call[wire.OKResult](d.c, wire.MethodDialogsShowWebDialog, wire.ShowWebDialogArgs{Dialog: spec})
}
...
func (d Dialogs) CloseWebDialog(id string) (wire.OKResult, error) {
	return call[wire.OKResult](d.c, wire.MethodDialogsCloseWebDialog, wire.CloseWebDialogArgs{ID: id})
}
...
func (d Dialogs) ListWebViews() (wire.ListWebViewsResult, error) {
	return call[wire.ListWebViewsResult](d.c, wire.MethodDialogsListWebViews, nil)
}
