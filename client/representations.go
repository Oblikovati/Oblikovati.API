...
func (d DesignReps) Capture(name string) (wire.DesignViewResult, error) {
	...
	return r, d.c.call(wire.MethodDesignRepsCapture, wire.CaptureRepArgs{Name: name}, &r)
}
...
func (d DesignReps) Activate(id uint64) (wire.DesignViewResult, error) {
	var r wire.DesignViewResult
	return r, d.c.call(wire.MethodDesignRepsActivate, wire.RepRef{ID: id}, &r)
}
...
func (d DesignReps) List() (wire.DesignViewsResult, error) {
	var r wire.DesignViewsResult
	return r, d.c.call(wire.MethodDesignRepsList, struct{}{}, &r)
}
...
func (d DesignReps) Delete(id uint64) (wire.DesignViewsResult, error) {
	var r wire.DesignViewsResult
	return r, d.c.call(wire.MethodDesignRepsDelete, wire.RepRef{ID: id}, &r)
}
...
func (d DesignReps) SetVisibility(args wire.SetVisibilityArgs) (wire.DesignViewResult, error) {
	var r wire.DesignViewResult
	return r, d.c.call(wire.MethodDesignRepsSetVisibility, args, &r)
}
...
func (d DesignReps) SetAppearance(args wire.SetAppearanceArgs) (wire.DesignViewResult, error) {
	var r wire.DesignViewResult
	return r, d.c.call(wire.MethodDesignRepsSetAppearance, args, &r)
}
...
func (p PositionalReps) Capture(name string) (wire.PositionalResult, error) {
	var r wire.PositionalResult
	return r, p.c.call(wire.MethodPositionalRepsCapture, wire.CaptureRepArgs{Name: name}, &r)
}
...
func (p PositionalReps) Activate(id uint64) (wire.PositionalResult, error) {
	var r wire.PositionalResult
	return r, p.c.call(wire.MethodPositionalRepsActivate, wire.RepRef{ID: id}, &r)
}
...
func (p PositionalReps) List() (wire.PositionalsResult, error) {
	var r wire.PositionalsResult
	return r, p.c.call(wire.MethodPositionalRepsList, struct{}{}, &r)
}
...
func (p PositionalReps) Delete(id uint64) (wire.PositionalsResult, error) {
	var r wire.PositionalsResult
	return r, p.c.call(wire.MethodPositionalRepsDelete, wire.RepRef{ID: id}, &r)
}
...
func (p PositionalReps) SetOverride(args wire.SetPositionalOverrideArgs) (wire.PositionalResult, error) {
	var r wire.PositionalResult
	return r, p.c.call(wire.MethodPositionalRepsSetOverride, args, &r)
}
...
func (p PositionalReps) SetFlexible(args wire.SetFlexibleArgs) (wire.PositionalResult, error) {
	var r wire.PositionalResult
	return r, p.c.call(wire.MethodPositionalRepsSetFlexible, args, &r)
}
...
func (l LODReps) Capture(name string) (wire.LODResult, error) {
	var r wire.LODResult
	return r, l.c.call(wire.MethodLODRepsCapture, wire.CaptureRepArgs{Name: name}, &r)
}
...
func (l LODReps) Activate(id uint64) (wire.LODResult, error) {
	var r wire.LODResult
	return r, l.c.call(wire.MethodLODRepsActivate, wire.RepRef{ID: id}, &r)
}
...
func (l LODReps) List() (wire.LODsResult, error) {
	var r wire.LODsResult
	return r, l.c.call(wire.MethodLODRepsList, struct{}{}, &r)
}
...
func (l LODReps) Delete(id uint64) (wire.LODsResult, error) {
	var r wire.LODsResult
	return r, l.c.call(wire.MethodLODRepsDelete, wire.RepRef{ID: id}, &r)
}
...
func (l LODReps) SetSuppressed(args wire.SetSuppressedArgs) (wire.LODResult, error) {
	var r wire.LODResult
	return r, l.c.call(wire.MethodLODRepsSetSuppressed, args, &r)
}
...
func (m ModelStates) Create(args wire.CreateModelStateArgs) (wire.ModelStateResult, error) {
	var r wire.ModelStateResult
	return r, m.c.call(wire.MethodModelStatesCreate, args, &r)
}
...
func (m ModelStates) Activate(id uint64) (wire.ModelStateResult, error) {
	var r wire.ModelStateResult
	return r, m.c.call(wire.MethodModelStatesActivate, wire.RepRef{ID: id}, &r)
}
...
func (m ModelStates) List() (wire.ModelStatesResult, error) {
	var r wire.ModelStatesResult
	return r, m.c.call(wire.MethodModelStatesList, struct{}{}, &r)
}
...
func (m ModelStates) Delete(id uint64) (wire.ModelStatesResult, error) {
	var r wire.ModelStatesResult
	return r, m.c.call(wire.MethodModelStatesDelete, wire.RepRef{ID: id}, &r)
}
