...
func (s SheetMetal) GetStyle() (wire.SheetMetalStyleResult, error) {
	return call[wire.SheetMetalStyleResult](s.c, wire.MethodSheetMetalGetStyle, struct{}{})
}
...
func (s SheetMetal) SetStyle(args wire.SetSheetMetalStyleArgs) (wire.SheetMetalStyleResult, error) {
	return call[wire.SheetMetalStyleResult](s.c, wire.MethodSheetMetalSetStyle, args)
}
...
func (s SheetMetal) BendAllowance(args wire.BendAllowanceArgs) (wire.BendAllowanceResult, error) {
	return call[wire.BendAllowanceResult](s.c, wire.MethodSheetMetalBendAllowance, args)
}
...
func (s SheetMetal) Bends() (wire.BendsResult, error) {
	return call[wire.BendsResult](s.c, wire.MethodSheetMetalBends, struct{}{})
}
...
func (s SheetMetal) Unfold() (wire.UnfoldResult, error) {
	return call[wire.UnfoldResult](s.c, wire.MethodSheetMetalUnfold, struct{}{})
}
